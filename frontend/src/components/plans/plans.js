...
class Plans extends React.Component {
    ...
    render(){
        ...
        if (roleNumber === 1) {
            var role = 'free package';
        }
        else if (roleNumber === 2) {
            var role = 'monthly subscription'
        }
        else {
            var role = 'yearly subscription'
        }
        ...
        return (
            ...
            <section style = {{zIndex: '-1'}} className="pricing-section">
                <div className="container mt0">
                    ...
                    <div className="blink">
                    <span className = 'blinkSpan'><h2>Your current plan is {role} and {this.state.dayMessage}</h2></span></div>
